...
export default function Logement() {
  ...
  useEffect(() => {
    ...
    setLoading(false); // Définir le chargement sur false une fois que la propriété est trouvée
  }, [id]);
  ...
  // Si la page est en train de charger, afficher un message de chargement
  if (loading) {
